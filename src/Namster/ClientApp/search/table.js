...
export default class ResultsTable extends React.Component {
  ...
  actions = [{ label: "Close", onClick: () => this.handleToggle(null) }];
  ...
  renderDialog = (item) => {
    return (
      ...
      >
        ...
        <br />
        <b>Department Number:</b> {item.departmentNumber}
        <br />
        <b>Status:</b> {item.status}
        <br />
        <b>Caan Zone:</b> {item.caanZone}
        <br />
        <b>Billing ID:</b> {item.billingId}
        <br />
        <b>Id:</b> {item.id}
        <br />
        <b>Division:</b> {item.division}
        <br />
        <b>Subnet:</b> {item.subnet}
        <br />
        <b>Mask:</b> {item.mask}
        <br />
  ...
  renderRow = (item, index) => {
    ...
    const building =
      highlights[index].building !== undefined
    ...
    return (
      <TableRow
        key={item.namNumber}
        onClick={() => this.handleToggle(item.namNumber)}
      >
